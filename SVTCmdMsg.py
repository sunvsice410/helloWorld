...
###########################################################################
#                   Copyright by UCIT                                     #
#         Create by sunshiguo for simulating SVTCmd Req Msg               #
#                                                                         #
#                         2020.12.01                                      #
#                                                                         #
#                                                                         #
...
class SVTRepMsg(object):
    def decode_MsgBody(self, payload, UIDisp):
        ...
        if 0xc1 == int(sPayload[6:8], 16):
            UIDisp.connect_log("=========SVT CMD Resp Msg Body begin===========")
            ...
            UIDisp.connect_log("=========SVT CMD Resp Msg Body end  ===========")
        else:
            UIDisp.connect_log("=========SVT CMD Resp Msg Body begin===========")
